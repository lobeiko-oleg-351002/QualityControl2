...
namespace QualityControl_Server.Forms.CustomerDirectory
{
    public partial class AddCustomerForm : AddForm
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (Contract != null)
            {
                ContractLib.Entities.Add(Contract);
        ...
        {
            ContractLib.Entities.RemoveAt(listBox1.SelectedIndex);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (i != -1)
            {
                ChangeContractForm ContractForm = new ChangeContractForm(ContractLib.Entities[i]);
                ContractForm.ShowDialog(this);

                BllContract Contract = ContractForm.oldContract;
                if (Contract != null)
                {
                    ContractLib.Entities[i] = Contract;

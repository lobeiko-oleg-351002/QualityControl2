...
namespace DAL.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private ContractLibRepository contractLibRepository;
        ...
        public IContractLibRepository ContractLibs
            => contractLibRepository ?? (contractLibRepository = new ContractLibRepository(context));
